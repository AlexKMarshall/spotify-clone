...
const UserProfile = () => {
  ...
  return (
    <button className="flex items-center py-1 pr-1 rounded-full hover:bg-spotify-gray-600">
      ...
      <span className="ml-2 font-bold text-white hover:underline">{user.display_name}</span>
      <span className="ml-1">
        <svg className="w-6 h-6 text-white fill-current" viewBox="0 0 24 24" width="24" height="24">
          <path
